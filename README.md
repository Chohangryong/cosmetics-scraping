...
- 올리브영·무신사의 **베스트 랭킹 페이지를 자동으로 열어서** 순위 데이터를 긁어옵니다
- 수집할 때마다 **SQLite DB에 시점을 기록**해 누적합니다
- 쌓인 데이터로 **순위 변동·브랜드 점유율·가성비 리포트**를 뽑습니다

두 사이트 모두 일반 HTTP 요청은 403으로 막혀 있습니다. [Scrapling](https://github.com/D4Vinci/Scrapling)의 스텔스 브라우저 자동화를 통해 봇 차단을 우회합니다.

---

## 주요 기능

- **랭킹 수집**: 올리브영 3개 카테고리 × TOP 50 (무신사는 Phase 2)
...
| 무신사뷰티 | 🔧 Phase 2 (카테고리 URL 확정 작업 중) |
